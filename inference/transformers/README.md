...
`/mnt/data_1.5t/outputs/inference_*_transformers/` and are what the other stacks diff
...
One venv serves all three leaves. Campaign venvs were removed in the 2026-08 reorg;
rebuild from this requirements file. Never install flash-attn on ROCm — the attention
path is `sdpa`.
...
## Install (NVIDIA / CUDA 13 — H100, verified 2026-08-22)
...
One venv serves all three leaves (offline: `HF_HOME=/mnt/.../models HF_HUB_OFFLINE=1
...
## H100 verification summary (2026-08-22, 1× H100 80GB, physical GPU 5)
...
`/dev/shm/h100/out/transformers/{llm,embedding,reranker}/`:
...
**Multi-GPU deferred** (GPUs 0–3 held by a production job). A 2-GPU pass would use
...
- **NVIDIA H100 (Hopper cc9.0, CUDA 13.0, driver 580.173.02): verified 2026-08-22** —
